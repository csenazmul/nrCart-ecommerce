    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, choices=[('PayPal', 'PayPal'), ('Strip', 'Strip'), ('Flutterwave', 'Flutterwave'), ('Paysatck', 'Paysatck'), ('RazorPay', 'RazorPay'), ('Bkash', 'Bkash'), ('Nagod', 'Nagod')], default=None, max_length=100, null=True)),
                ('order_status', models.CharField(choices=[('Pending', 'Pending'), ('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Flufilled', 'Flufilled'), ('Cancelled', 'Cancelled')], default='Pending', max_length=100)),
                ('initial_total', models.DecimalField(decimal_places=2, default=0.0, help_text='The orginal total be', max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('review', models.TextField(blank=TabError, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.CharField(choices=[('Pending', 'Pending'), ('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Flufilled', 'Flufilled'), ('Cancelled', 'Cancelled')], default='Pending', max_length=100)),
                ('shipping_service', models.CharField(blank=True, choices=[('DHL', 'DHL'), ('FedX', 'FedX'), ('RedX', 'RedX'), ('UPS', 'UPS'), ('GIG Logistics', 'GIG Logistics')], default=None, max_length=100, null=True)),
                ...
                ('saved', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Amount save', max_digits=12, null=True)),
