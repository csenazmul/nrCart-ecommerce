# Generated by Django 4.2 on 2024-10-22 11:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('PayPal', 'PayPal'), ('Strip', 'Strip'), ('Flutterwave', 'Flutterwave'), ('Paysatck', 'Paysatck'), ('RazorPay', 'RazorPay'), ('Indian Bank Account', 'Indian Bank Account'), ('USA Bank Account', 'USA Bank Account'), ('Bkash', 'Bkash'), ('Nagod', 'Nagod')], max_length=50, null=True)),
